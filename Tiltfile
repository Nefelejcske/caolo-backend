...
local_resource('sim-tests', cmd='make -C sim test', deps=['./sim/simulation/', './sim/worker/', './sim/Cargo.lock'], allow_parallel=True)
local_resource('rt-tests', cmd='make -C rt test', deps=['./rt'], allow_parallel=True)
